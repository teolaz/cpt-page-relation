<?php
    ...
    class TeolazCptPageRelationAdminInterface
    {
        ...
        {
            add_options_page(__('Custom Post Type / Page Relation', TEXTDOMAIN), __('Custom Post Type / Page Relation', TEXTDOMAIN), 'manage_options', 'teolaz-cpt-page-relation-menu', array(
                $this,
                'setMenuPage',
            ));
        }
        ...
        public function setMenuPage()
        {
            ...
            add_thickbox();
            ?>
            <h1><?php _e('Custom Post Type / Page Relation - Plugin Options', TEXTDOMAIN); ?></h1>
            <hr>
                                    ...
                                    <td><?php
                                            if ( $this->languages ) {
                                                ...
                                                foreach ( $this->languages as $language ) :
                                                    ?>
                                                    <div class="flag">
                                                        <img class="flag-selector"
                                                             src="<?php echo $language[ 'country_flag_url' ]; ?>"/> :
                                                        <select
                                                            name="<?php echo 'resultPosts[' . $post_type->name . '][' . $language[ 'language_code' ] . ']'; ?>">
                                                            <?php
                                                ...
                                                <div class="flag">
                                                    ...
                                                    <select
                                                        name="<?php echo 'resultPosts[' . $post_type->name . '][default]'; ?>">
                                                        <?php
                                                            $pages = $this->pages;
                                                            echo '<option value=""> --- </option>';
                                                            foreach ( $pages as $page ) :
